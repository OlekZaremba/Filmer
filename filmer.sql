...
(45, 'Harry Potter and the Sorcerer\'s Stone', NULL, 'Chłopiec odkrywa, że jest czarodziejem, i wyrusza do Szkoły Magii i Czarodziejstwa w Hogwarcie.', 2, 1, 1, 2, 2),
(46, 'The Hobbit: An Unexpected Journey', NULL, 'Bilbo Baggins wyrusza na wyprawę z krasnoludami, aby odzyskać ich królestwo.', 4, 3, 1, 1, 1),
(47, 'Zootopia', NULL, 'Królik policjant i cyniczny lis detektyw rozwiązują tajemnicę w metropolii zwierząt.', 3, 5, 1, 1, 2),
(48, 'Frozen', NULL, 'Dwójka sióstr walczy o ocalenie swojego królestwa, które zostało pokryte wiecznym lodem.', 2, 5, 1, 4, 2),
(49, 'Jurassic Park', NULL, 'Naukowcy ożywiają dinozaury, ale park rozrywki szybko zamienia się w koszmar.', 5, 2, 1, 3, 3),
(50, 'Pirates of the Caribbean: The Curse of the Bl', NULL, 'Kapitan Jack Sparrow wyrusza na przygodę, by odzyskać swój statek.', 3, 4, 1, 5, 2),
(51, 'The Hunger Games', NULL, 'Młoda dziewczyna staje do walki na śmierć i życie w dystopijnym państwie.', 4, 3, 1, 1, 4),
(52, 'Inside Out', NULL, 'Personifikacje emocji pomagają młodej dziewczynie poradzić sobie ze zmianami w życiu.', 2, 5, 1, 4, 2),
(53, 'The Shape of Water', NULL, 'Niezwykła historia miłości między niemą kobietą a wodnym stworzeniem.', 9, 4, 1, 3, 4),
(54, 'Logan', NULL, 'Zmęczony życiem Wolverine staje przed ostatnim wyzwaniem, aby chronić młodą mutantkę.', 1, 1, 1, 2, 3),
(55, 'Black Swan', NULL, 'Historia baletnicy, która traci kontrolę nad własnym umysłem w drodze do perfekcji.', 8, 4, 1, 3, 5),
(56, 'Shutter Island', NULL, 'Detektyw odkrywa mroczne sekrety wyspy zamieszkałej przez niebezpiecznych pacjentów.', 5, 2, 1, 1, 5),
(57, 'The Sixth Sense', NULL, 'Psycholog dziecięcy pomaga chłopcu, który widzi zmarłych.', 9, 3, 1, 4, 5),
(58, 'Gone Girl', NULL, 'Mąż staje się głównym podejrzanym w sprawie zaginięcia swojej żony.', 8, 4, 1, 5, 5),
(59, 'Oldboy', NULL, 'Mężczyzna zostaje porwany na 15 lat i próbuje rozwikłać tajemnicę swojego oprawcy.', 10, 5, 1, 3, 5),
(60, 'The Machinist', NULL, 'Bezsenność prowadzi pracownika fabryki do granic szaleństwa i paranoi.', 8, 1, 1, 2, 5),
(61, 'Prisoners', NULL, 'Ojciec rozpoczyna desperackie poszukiwania swojej zaginionej córki.', 12, 3, 1, 1, 5),
(62, 'Memento', NULL, 'Mężczyzna z zanikiem pamięci krótkotrwałej próbuje rozwiązać zagadkę morderstwa swojej żony.', 1, 2, 1, 4, 5),
(63, 'The Others', NULL, 'Kobieta podejrzewa, że w jej domu znajdują się duchy.', 13, 4, 1, 2, 5),
(64, 'Requiem for a Dream', NULL, 'Opowieść o uzależnieniach i ich wpływie na życie czterech osób.', 8, 5, 1, 5, 5);
